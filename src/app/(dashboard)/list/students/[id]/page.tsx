                ...
                <div className="flex flex-col lg:flex-row gap-4">
                    <div className="bg-lamaSky py-6 px-4 rounded-md flex-1 flex gap-4">
                        ...
                        <div className="w-2/3 flex-col justify-between gap-4">
                            <h1 className="text-xl font-semibold">Cameronm Moran Snyder</h1>
            ...
            <div className="w-full xl:w-1/3 flex flex-col gap-4">
                <div className="bg-white p-4 rounded-md">
                    ...
                    <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-500">
                        ...
                        <Link className="p-3 rounded-md bg-lamaSkyLight" href={`/list/teachers?classId=${1}`}>Student&apos;s Teachers</Link>
