                ...
                <div className="flex flex-col lg:flex-row gap-4">
                    <div className="bg-lamaSky py-6 px-4 rounded-md flex-1 flex gap-4">
                        ...
                        <div className="w-2/3 flex-col justify-between gap-4">
                            ...
                            <p className="text-sm to-gray-500 mt-2">Lorem ipsum, dolor sit amet consectetur adipisicing elit.</p>
                            <div className="flex items-center justify-between gap-2 flex-wrap text-sm font-medium mt-2">
                                <div className="w-full md:w-1/3 lg:w-full 2xl:w-[48%] flex items-center gap-2">
                    ...
                    <div className="flex-1 flex gap-4 justify-between flex-wrap">
                        <div className="w-full bg-white p-4 flex rounded-md gap-4 md:w-[48%] xl:w-[45%] 2xl:w-[48%]">
            ...
            <div className="w-full xl:w-1/3 flex flex-col gap-4">
                <div className="bg-white p-4 rounded-md">
                    ...
                    <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-500">
                        <Link className="p-3 rounded-md bg-lamaSky" href={`/list/classes?supervisorId=${"mikegeller"}`}>Teacher&apos;s Classes</Link>
                        <Link className="p-3 rounded-md bg-lamaSkyLight" href={`/list/students?teacherId=${"mikegeller"}`}>Teacher&apos;s Students</Link>
