            ...
            <SignIn.Root>
                <SignIn.Step name='start' className='bg-white p-12 rounded-md shadow-2xl flex flex-col gap-2'>
                    <h1 className='text-xl font-bold flex items-center gap-2'>
                        <Image src="/logo.png" alt="" width={24} height={24}/>Vidal School
                    </h1>
                    ...
                    <Clerk.Field name="identifier" className='flex flex-col gap-2'>
                        ...
                        <Clerk.Input type="text" required className='p-2 ring-1 ring-gray-300'/>
                    ...
                    <Clerk.Field name="password" className='flex flex-col gap-2'>
                        ...
                        <Clerk.Input type="password" required className='p-2 ring-1 ring-gray-300'/>
                        <Clerk.FieldError className='text-sm text-red-400'/>
                    </Clerk.Field>
